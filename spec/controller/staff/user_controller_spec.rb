...
describe Staff::UsersController do
  ...
  describe "POST 'create'" do
    ...
    def post_create(options = {})
      post :create, :admin => {:first_name => "Matthew", :last_name => "Bergman", :username => 'fotoverite', :password => "markie123", :password_confirmation => 'markie123', :email => "dosomething@dosomething.com"}.merge(options)
    end
